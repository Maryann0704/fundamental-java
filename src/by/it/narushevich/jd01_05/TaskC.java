/* Напишите в пакете by.it.фамилия.jd01_05класс TaskC, который решает задачу: см. рис. TaskC.png */
...
public class TaskC {
    public static void main(String[] args) {
        ...
        printArray(randomArray, "M"); // вывод массива в 5 колонок с заголовком и индексом
        System.out.println();
        ...
        printArray(newRandomArray, "N");        // вывод массива в 5 столбцов с индексами и заголовками
        System.out.println();
    ...
    private static double middleGeom(double[] array) {
        ...
        /*формула среднего геометрического: корень n-ой степени из произведения членов массива,
        где n, число элементов массива */
        double exponent;
        if (counter > 0) {
            exponent = 1.0 / (double) counter;
        } else throw new ArithmeticException();

        result = pow(production, exponent);
